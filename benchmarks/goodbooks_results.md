...
Subsampled to 2500 users (~279k interactions) so the dense user-user similarity needed by UserKNN fits in memory. HybridBook fuses ItemKNN with a tag-based ContentBased via HybridRecommender (RRF).
